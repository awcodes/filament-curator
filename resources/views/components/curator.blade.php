<div x-data="{
    ...
    resetPicker: function() {
     ...
     x-on:close-modal.window="$event.detail.id === 'filament-curator' ? resetPicker() : null"
        ...
        <div class="filament-curator-media-picker-modal-content flex-1 overflow-hidden">
            ...
            <div class="flex flex-col h-full" wire:ignore>
                ...
                <div class="relative flex flex-1 w-full h-full overflow-hidden">
                    ...
                    <div class="hidden flex flex-col w-full h-full max-w-xs overflow-auto bg-gray-100 lg:!block dark:bg-gray-900">
                        <div class="py-2 px-4">
                            <label>
