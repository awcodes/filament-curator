...
>
    ...
    >
        <div
            @class([
                "flex flex-wrap items-center gap-6" => count($items) <= 3,
            ...
            @foreach ($items as $uuid => $item)
                <div
                    {{
                        $attributes->merge($getExtraAttributes())->class([
                            "checkered relative block flex w-full justify-center overflow-hidden rounded-lg border border-gray-300 shadow-sm transition duration-75 dark:border-gray-700 dark:bg-gray-800 dark:text-white",
                ...
                >
                    @if (str($item["type"])->contains("image"))
                        <img
                            ...
                            @class([
                                ...
                                "w-full object-cover" => ! $isConstrained(),
                            ])
                        />
                    ...
                    <div class="absolute right-0 top-0">
                        <div
                            class="relative flex items-center divide-x divide-gray-700 rounded-bl-lg bg-gray-900 shadow-md"
                        >
                            @if ($isMultiple)
                                <button
                                    ...
                                    type="button"
                                    class="flex h-10 w-10 flex-none cursor-grab items-center justify-center text-gray-400 transition hover:text-gray-300"
                                >
                                    <svg
                            ...
                            >
                                <x-slot name="trigger">
                                    <button
                                        ...
                                        type="button"
                                        class="flex h-10 w-10 flex-none items-center justify-center text-gray-400 transition hover:text-gray-300"
                                    >
